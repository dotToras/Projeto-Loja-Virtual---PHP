<div class="container-fluid">
    ...
    $consulta->closeCursor();
    $produto = $exibe['nmProd'];  // variável que recebe o produto
    $preco = number_format(($exibe['vlProd']),2,',','.'); // variável que recebe o preço
    $total += $exibe['vlProd'] * $qnt; // variável que recebe preço * quantidade
